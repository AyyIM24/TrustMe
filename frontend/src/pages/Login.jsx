    ...
    <div className="relative min-h-screen bg-[#FFE6EE] text-slate-900 flex items-center justify-center pt-12 pb-12 px-4 font-sans transition-colors duration-300">
      ...
      >
        <div className="bg-[#D6EBFC]/95 border border-pink-300 shadow-card-hover hover:border-pink-400 rounded-3xl p-6 md:p-8 space-y-6 transition-all duration-300">
          ...
          {/* Google OAuth Section — Styled to match TrustMe AI theme (Dense Light Blue, Pink Borders, Zero White) */}
          <div className="space-y-2">
            <div className="relative w-full overflow-hidden rounded-xl group">
              {/* Theme-Matching Visual Button */}
              <motion.button
                type="button"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                ...
                className="w-full flex items-center justify-center gap-3 py-3 rounded-xl font-bold text-sm font-mono bg-[#C8E4FA] hover:bg-[#BEE0FB] border border-pink-300 hover:border-pink-400 text-slate-800 shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer"
              >
              ...
              {/* Native Google GSI Invisible Click Overlay */}
              <div
                id="googleSignInDiv"
                className="absolute inset-0 w-full h-full opacity-[0.001] cursor-pointer overflow-hidden z-10 [&_iframe]:!w-full [&_iframe]:!h-full [&_iframe]:!scale-125 [&>div]:!w-full [&>div]:!h-full"
